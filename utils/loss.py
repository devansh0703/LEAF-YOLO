...
from utils.general import bbox_iou, bbox_alpha_iou, box_iou, box_giou, box_diou, box_ciou, xywh2xyxy, shape_iou, inner_shape_iou
    ...
    def __call__(self, p, targets):  # predictions, targets, model
        ...
        for i, pi in enumerate(p):  # layer index, layer predictions
            ...
            if n:
                ...
                iou = inner_shape_iou(pbox.T, tbox[i], x1y1x2y2=False, scale=0.0)  # iou(prediction, target)
    ...
    def __call__(self, p, targets, imgs):  # predictions, targets, model   
        ...
        for i, pi in enumerate(p):  # layer index, layer predictions
            ...
            if n:
                ...
                iou = inner_shape_iou(pbox.T, selected_tbox, x1y1x2y2=False, scale=0.0)  # iou(prediction, target)
